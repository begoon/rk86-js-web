 ...
 * @returns {number}
 */
export const extract_rk86_word = function (v, i) {
 ...
 * @returns {string}
 */
export const to_text = (binary) => binary.reduce((a, x) => a + String.fromCharCode(x), "");
 ...
 * @returns {number[]}
 */
export const convert_hex_to_binary = function (text) {
    const lines = text
        .split("\n")
 ...
 * @returns {string}
 */
export const file_ext = (filename) => {
 ...
 */
export function extact_metadata(text) {
