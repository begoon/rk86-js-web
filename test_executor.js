...
import { Tracer } from "./test_console_tracer.js";
import { load_file } from "./test_load_file.js";
import { IO, Memory } from "./test_machine.js";

export async function executor(filename, verbose = false, timeout = 60 * 20) {
